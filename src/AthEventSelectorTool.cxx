...
#include "wwwAnalysis/AthEventSelectorTool.h"
...
#include "wwwAnalysis/TEventSelectorTool"
...
//=============================================================================
AthEventSelectorTool::AthEventSelectorTool( const std::string& type,
 ...
 m_rootTool(0)
{
  ...
  m_rootTool = new Root::TEventSelectorTool();
...
// Standard destructor
//=============================================================================
AthEventSelectorTool::~AthEventSelectorTool()
{
...
//=============================================================================
StatusCode AthEventSelectorTool::initialize()
{
  // We need to initialize the underlying ROOT TSelectorTool
  if ( 0 == m_rootTool->initialize() )
    {
      ATH_MSG_ERROR ( "ERROR! Could not initialize the TEventSelectorTool!" );
...
//=============================================================================
StatusCode AthEventSelectorTool::finalize()
{
...
//=============================================================================
const Root::TAccept& AthEventSelectorTool::accept( const INavigable4Momentum* part )
{
  if ( !part )
    {
