...
#include "wwwAnalysis/AthElectronSelectorTool.h"
...
#include "wwwAnalysis/TElectronSelectorTool"
...
//=============================================================================
AthElectronSelectorTool::AthElectronSelectorTool( const std::string& type,
 ...
 m_rootTool(0)
{
  ...
  m_rootTool = new Root::TElectronSelectorTool();
...
// Standard destructor
//=============================================================================
AthElectronSelectorTool::~AthElectronSelectorTool()
{
...
//=============================================================================
StatusCode AthElectronSelectorTool::initialize()
{
  // We need to initialize the underlying ROOT TSelectorTool
  if ( 0 == m_rootTool->initialize() )
    {
      ATH_MSG_ERROR ( "ERROR! Could not initialize the TElectronSelectorTool!" );
...
//=============================================================================
StatusCode AthElectronSelectorTool::finalize()
{
...
//=============================================================================
const Root::TAccept& AthElectronSelectorTool::accept( const INavigable4Momentum* part )
{
  if ( !part )
    {
